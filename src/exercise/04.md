...
It's just a great example of how to use windowing to handle rendering of enormous lists.
2 libraries are used here to help us out, it's: downshift and react-virtual
